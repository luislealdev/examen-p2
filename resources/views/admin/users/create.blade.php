                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <div class="form-text">
                                <strong>Empleado:</strong> Puede gestionar películas, inventarios, tiendas y clientes.<br>
                                <strong>Administrador:</strong> Acceso completo incluido gestión de usuarios y personal.
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Nota:</strong> Los usuarios creados aquí tendrán acceso al panel de administración. 
                            Los clientes regulares se registran a través del formulario público de registro.
                        </div>
